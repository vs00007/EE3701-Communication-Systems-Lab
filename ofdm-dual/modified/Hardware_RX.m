...
while(state == 1)
    ...
    if Run_time_number > Ready_Time
        ...
        % ----- Demodulation -----%
        [M_n,Threshold_graph,H_est_time,RX_Payload_1_no_Equalizer,RX_Payload_2_no_Equalizer,RX_Payload_1_no_pilot,RX_Payload_2_no_pilot,BER, H_est] = OFDM_rx2(RX,Parameters_struct);
