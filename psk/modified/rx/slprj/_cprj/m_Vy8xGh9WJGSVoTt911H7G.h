#ifndef __Vy8xGh9WJGSVoTt911H7G_h__
#define __Vy8xGh9WJGSVoTt911H7G_h__
...
#ifndef typedef_coder_array_creal_T_2D
#define typedef_coder_array_creal_T_2D
...
typedef struct {
  ...
  int32_T size[2];
} coder_array_creal_T_2D;

#endif                                 /* typedef_coder_array_creal_T_2D */

#ifndef struct_tag_kJUqjKSnL34l7kyLrLrmKG
#define struct_tag_kJUqjKSnL34l7kyLrLrmKG

struct tag_kJUqjKSnL34l7kyLrLrmKG
{
  ...
  real_T pProportionalGain;
  real_T pIntegratorGain;
  real_T pDigitalSynthesizerGain;
  real_T pPhase;
  creal_T pPreviousSample;
  real_T pActualPhaseOffset;
  real_T pLoopFilterState;
  real_T pIntegFilterState;
  real_T pDDSPreviousInput;
};

#endif                                 /* struct_tag_kJUqjKSnL34l7kyLrLrmKG */

#ifndef typedef_comm_CarrierSynchronizer
#define typedef_comm_CarrierSynchronizer

typedef struct tag_kJUqjKSnL34l7kyLrLrmKG comm_CarrierSynchronizer;

#endif                                 /* typedef_comm_CarrierSynchronizer */

#ifndef typedef_coder_array_creal_T
#define typedef_coder_array_creal_T
...
#endif                                 /* typedef_coder_array_creal_T */

#ifndef typedef_InstanceStruct_Vy8xGh9WJGSVoTt911H7G
#define typedef_InstanceStruct_Vy8xGh9WJGSVoTt911H7G
...
typedef struct {
  ...
  creal_T (*u0_data)[7330];
  int32_T (*u0_sizes)[2];
  creal_T (*y0_data)[7330];
  int32_T (*y0_sizes)[2];
  int32_T (*v)[2];
} InstanceStruct_Vy8xGh9WJGSVoTt911H7G;

#endif                                 /* typedef_InstanceStruct_Vy8xGh9WJGSVoTt911H7G */
...
extern void method_dispatcher_Vy8xGh9WJGSVoTt911H7G(SimStruct *S, int_T method,
  void* data);
